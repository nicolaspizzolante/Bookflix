...
$sql = "SELECT id FROM historial WHERE libro_id = '$libro_id' AND usuario_id = '$usuario_id'";
...
if($resultado != null){
    ...
    $sql = "INSERT INTO historial (libro_id, usuario_id, fecha) VALUES ('$libro_id', '$usuario_id', '$fecha')";
}
